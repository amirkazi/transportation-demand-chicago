...
ggplot() +
  geom_rect(aes(xmin = 0, xmax = 4, ymin = ymin, ymax = ymax), fill = "#824CD9", alpha = 0.3) +
  geom_line(data = lol_effected, aes(x = days_to_lolla, y = riders/3), colour = "pink") +
  geom_line(data = lol_uneffected, aes(x = days_to_lolla, y = riders/3), colour = "blue") +
  scale_y_continuous(labels = scales::comma) +
  scale_x_continuous(breaks = c(-10:14)) +
  theme_bw() +
  my_theme
...
ggplot() +
  geom_rect(aes(xmin = 0, xmax = 4, ymin = ymin, ymax = ymax), fill = "#824CD9", alpha = 0.3) +
  geom_line(data = lol_effected, aes(x = days_to_lolla, y = riders), colour = "pink", 
              ) +
  geom_smooth(data = lol_effected, aes(x = days_to_lolla, y = riders), colour = "pink", 
            ) +
  geom_smooth(data = lol_uneffected, aes(x = days_to_lolla, y = riders), colour = "blue",
              se = FALSE, na.rm = TRUE) +
  scale_y_continuous(labels = scales::comma) +
  scale_x_continuous(breaks = c(-10:14)) +
  my_theme +
