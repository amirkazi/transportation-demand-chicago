...
taxi_2016 <- read.csv (here::here("data", "2016_Taxi_Trips1.csv"))
taxi_2016 <-
  taxi_2016 %>%
...
taxi_starts <- st_as_sf(y, coords=c("Pickup.Centroid.Longitude","Pickup.Centroid.Latitude"),
...
ggplot(data = taxi_starts) +
  ...
  labs (title ="Airports & South Side Trips Generate Highest Median Revenue for Taxi Drivers", 
       ...
       x = "", 
       y = "",
       caption = "Chicago Taxi Trips 2016 Data") 
