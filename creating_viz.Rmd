...
# Shading Winters over 3 months of Data
...
ggplot(public_transport, aes(x = date, y = rides)) +
  geom_smooth(aes(color = trip_identity)) +
  geom_rect(data=df,aes(xmin=xmin,ymin=ymin,xmax=xmax,ymax=ymax,fill=winters),
                    alpha=0.4,inherit.aes=FALSE)+
  scale_fill_manual(values=c("#CCFFFF")) + 
  labs(title ="Monthly Usage of Public Transport in Chicago Declines in Winter", 
       subtitle = "Train usage is more elastic to seasonal changes.",
       x = "", y = "Total Number of Passengers Per Day (Millions)",
       caption = "CTA Ridership Data 2015-2017") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0, size = 12, face = "bold"), 
        plot.subtitle = element_text(size = 10, face = "bold"),
